...
# ---------------------------------------------------------------------------
# Public-tests normalization for mixed-format boundary variants
# ---------------------------------------------------------------------------

def _normalize_public_tests_for_pytest(public_tests: str) -> str:
    ...
    *,
    ...
    for lst in (code_gen, boundary, static_repair, execution_repair):
        for i, s in enumerate(lst):
            normalized = _normalize_public_tests_for_pytest(s.public_tests)
