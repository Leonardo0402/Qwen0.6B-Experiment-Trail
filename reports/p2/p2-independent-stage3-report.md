...
| parent_adapter_weight_sha256 | `None` (independent mode) |
...
### 结论 4：Stage3 的提升主要来自 Repair 数据本身，而非 Continual 累积
...
**Independent Stage3 在 Repair 维度上优于 Continual Stage3-v2，但 Pass@1 持平，差异未达统计显著。** Continual Curriculum 的主要价值在于 family-level 稍多 1 个，但这不足以证明 Continual 优于 Independent。Stage3 的 Repair 提升主要来自 Repair 数据本身，而非 Continual 累积。
